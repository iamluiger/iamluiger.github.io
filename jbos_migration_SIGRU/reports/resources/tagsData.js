function fillTagService(tagService) {
	...
	tagService.registerTag(new Tag("techbox:web", "Web", false, true, null), ['techsector01:view','techrow:java-ee',]);
	tagService.registerTag(new Tag("play", "Play", false, false, null), ['web','framework:',]);
	tagService.registerTag(new Tag("jax-rs", null, false, false, null), ['techbox:http',]);
	...
	tagService.registerTag(new Tag("techbox:rest", "REST", false, true, null), ['techsector02:connect','techrow:embedded',]);
